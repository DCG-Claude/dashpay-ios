/* Dash Unified FFI Library - Combined Header */

#ifndef DASH_UNIFIED_FFI_H
#define DASH_UNIFIED_FFI_H

/* Generated unified header combining Core (SPV) and Platform SDK FFI libraries */
...
typedef struct ContextProviderHandle ContextProviderHandle;
...
/* Network enum - used by both SDKs */
...
/* ============================================== */
/* Core SDK (SPV) Types and Functions            */
/* ============================================== */
...
/* ============================================== */
/* Platform SDK Types and Functions               */
/* ============================================== */
...
typedef struct DashSDKConfig {
  ...
  enum FFINetwork /* mapped from FFINetwork */ network;
...
struct ContextProviderHandle *dash_sdk_context_provider_from_callbacks(const ContextProviderCallbacks *callbacks);
