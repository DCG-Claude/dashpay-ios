            ...
            Form {
                Section("Network") {
                    Picker("Current Network", selection: $appState.currentNetwork) {
                        ForEach(PlatformNetwork.allCases, id: \.self) { network in
                ...
                Section("Data") {
                    ...
                    // NavigationLink(destination: ContractBrowserView()) {
                    //     Label("Contract Explorer", systemImage: "doc.text.magnifyingglass")
                    // }
