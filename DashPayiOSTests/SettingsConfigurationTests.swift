...
final class SettingsConfigurationTests: XCTestCase {
    ...
    func testSPVConfigurationCreation() throws {
        ...
        let devnetConfig = try SPVConfigurationManager.shared.configuration(for: .devnet)
...
final class SettingsIntegrationTests: XCTestCase {
    ...
    func testSPVConfigurationIntegration() throws {
        ...
        for network in PlatformNetwork.allCases {
            ...
            switch network {
            case .mainnet:
                config = try SPVConfigurationManager.shared.configuration(for: .mainnet)
            case .testnet:
                config = try SPVConfigurationManager.shared.configuration(for: .testnet)
            case .devnet:
                config = try SPVConfigurationManager.shared.configuration(for: .devnet)
            }
